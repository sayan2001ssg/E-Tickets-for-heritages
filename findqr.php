...
<body>
	<p>
		...
		<?php
			print "Hello ";
			print $_SESSION['fname1'];
			print " ";
			print $_SESSION['lname1'];
		?>
		</h2>		
	</p>
	...
	<canvas id="qr-code"></canvas><br>
		<?php
		echo "<h2>Name: ", $_SESSION['fname1'], " ", $_SESSION['lname1'], "</h2>" ;
		echo "<strong>Place: </strong>", $_SESSION['place1'], "<br>","<strong>Date: </strong>", $_SESSION['date1'], "<br>", "<strong>Entry Time: </strong>", $_SESSION['time1'];
		?><br><br>
